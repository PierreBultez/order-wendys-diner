...
<template>
    <AuthLayout title="Mot de passe oublié" description="Entrez votre adresse e-mail afin de recevoir un lien de réinitialisation">
        <Head title="Mot de passe oublié - Wendy's Diner" />
